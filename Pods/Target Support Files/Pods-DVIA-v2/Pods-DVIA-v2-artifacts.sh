...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/GoogleAnalytics/Frameworks/GoogleAnalytics.xcframework" "" "false" "ios-arm64_armv7/GoogleAnalytics.framework" "ios-arm64_x86_64-maccatalyst/GoogleAnalytics.framework" "ios-arm64_i386_x86_64-simulator/GoogleAnalytics.framework"
fi
